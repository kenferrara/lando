---
title: Lando Recipes
metaTitle: Lando Recipes | Lando
description: A Lando recipe is a pre-configured application stack.
summary: Some vocabulary to help us understand the Lando ecosystem.
